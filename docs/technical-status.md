...
> 2026-09-13 更新：继续“小关重开 + 玩家精确恢复”，重编程重开和敌人精确恢复暂时搁置。v0.18.0 已补齐真实牌区顺序，v0.19.0 支持普通水果跨手/场/墓同身份副本。v0.20.0 已验证空牌库、带场地的空手牌以及全牌组在墓地；空手牌使用开发夹具造样本，再由正式 DLL 恢复，来源见 [第十九阶段](phase-19-empty-player-zones.md)。下一项扩展原生开局抽五张与目标布局不一致时的暂存规划，然后继续补玩家动态状态。
