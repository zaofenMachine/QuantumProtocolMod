...
> 2026-09-13 更新：按用户决定暂时搁置“重编程重开”，继续“小关重开 + 玩家精确恢复”。v0.17.0 的场地与墓地共存、统一搬牌计划及实机失败回退见 [第十六阶段](phase-16-player-field-and-trash.md)。下一项是手牌真实排列：本次截图确认，排序 Getter 相等并不保证手牌视觉顺序相同。跨手/场/墓的同身份卡、更多玩家动态状态仍待单独闭合。
