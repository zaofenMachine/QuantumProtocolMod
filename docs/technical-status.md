...
> 2026-09-13 当前续接入口：[第三十一阶段](phase-31-generated-empty-field.md)。按用户要求完成当前任务后暂停。v0.32.0 补齐春与额外苹果退场后“空场、6 手、3 墓”的精确恢复；墓地 schema 3 保持原生顺序和永久牌组，旧格式继续兼容，实机操作对照及回归通过。主方向仍是“小关重开 + 玩家精确恢复”，重编程与敌人精确恢复继续搁置。下一轮优先真实场外动态状态；满充能、更多生成卡、LEVEL、独立生命调整和效果动作历史仍有缺口。下面的旧调试材料保留为历史记录。
