...
> 2026-09-13 更新：继续“小关重开 + 玩家精确恢复”，重编程重开和敌人精确恢复暂时搁置。v0.18.0–v0.20.0 已接入真实牌序、普通水果跨区同名副本和受限空牌区。v0.21.0 用原生移牌调整开局手牌数量，读取公开容量七张，并在满手牌场地恢复时延后最后一张；全牌组在牌库和满手牌同名副本已实机验证。正式构建与夹具来源见 [第二十阶段](phase-20-player-hand-capacity.md)。下一项继续补玩家动态状态和更多场地卡。
