...
> 2026-09-13 更新：继续“小关重开 + 玩家精确恢复”，重编程重开和敌人精确恢复暂时搁置。v0.18.0 已补齐真实牌区顺序；v0.19.0 沿用原生有序副本计划，支持 schema 2 中苹果、柠檬、春跨手/场/墓的同身份分配。旧格式与其他特殊卡保留限制。证据见 [第十八阶段](phase-18-player-duplicate-zones.md)。下一项继续补空牌区和更多玩家动态状态。
