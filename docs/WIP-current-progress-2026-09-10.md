...
> 2026-09-13 当前续接入口：[第十七阶段](phase-17-native-player-zone-order.md)。按用户决定继续“小关重开 + 玩家精确恢复”，暂时搁置重编程重开与敌人精确恢复。场地与墓地共存已接入，新玩家牌区 schema 2 使用真实原生顺序，修正旧排序 Getter 遗漏抽牌及手牌排列的问题。下一项继续处理跨牌区同身份卡和更多玩家状态；下面的旧调试清单保留为历史材料。
